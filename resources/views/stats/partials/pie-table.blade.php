{{--
    ...
    Props: $title, $subtitle, $chartId, $itemHeader, $labels (array), $series (array).
    Pie + legend on the left; breakdown table (item | domains | %) on the right.
--}}
@php
            ...
            <table class="min-w-full text-sm">
                <thead>
                    <tr class="border-b border-slate-200 text-xs font-semibold uppercase tracking-wide text-slate-500">
                        ...
                        <th class="py-2 pr-4 text-right">Domains</th>
