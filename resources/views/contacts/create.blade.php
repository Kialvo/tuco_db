...
<div class="pt-4 border-t border-gray-100">
    ...
    <div class="grid grid-cols-3 gap-4">
        ...
        <div>
            ...
            <input type="text" name="first_contact_date" value="{{ old('first_contact_date') }}"
        ...
        <div>
            ...
            <select name="country_of_origin_id"
                ...
                @foreach($countries as $c)
                    <option value="{{ $c->id }}" {{ old('country_of_origin_id') == $c->id ? 'selected' : '' }}>
                        {{ $c->country_name }}
                    </option>
                @endforeach
            </select>
        ...
        <div>
            ...
            <select name="primary_language_id"
                ...
                @foreach($languages as $lang)
                    <option value="{{ $lang->id }}" {{ old('primary_language_id') == $lang->id ? 'selected' : '' }}>
                        {{ $lang->name }}
                    </option>
                @endforeach
            </select>
    ...
    <div class="space-y-2">
        ...
        <div class="flex items-center gap-3">
            ...
            <select name="channel_{{ $n }}" id="channel_{{ $n }}"
                ...
                <option value="">— none —</option>
                <option value="email"    {{ old('channel_'.$n) === 'email'    ? 'selected' : '' }}>Email</option>
                <option value="phone"    {{ old('channel_'.$n) === 'phone'    ? 'selected' : '' }}>Phone</option>
                <option value="whatsapp" {{ old('channel_'.$n) === 'whatsapp' ? 'selected' : '' }}>WhatsApp</option>
                <option value="telegram" {{ old('channel_'.$n) === 'telegram' ? 'selected' : '' }}>Telegram</option>
                <option value="linkedin" {{ old('channel_'.$n) === 'linkedin' ? 'selected' : '' }}>LinkedIn</option>
                <option value="facebook" {{ old('channel_'.$n) === 'facebook' ? 'selected' : '' }}>Facebook</option>
                <option value="discord"  {{ old('channel_'.$n) === 'discord'  ? 'selected' : '' }}>Discord</option>
            </select>
    ...
    <div class="grid grid-cols-2 gap-3">
        ...
        <div>
            ...
            <div class="flex rounded border border-gray-300 overflow-hidden focus-within:ring-1 focus-within:ring-green-500 focus-within:border-green-500">
                ...
                <input type="email" name="email" id="field_email" value="{{ old('email') }}"
        ...
        <div>
            ...
            <div class="flex rounded border border-gray-300 overflow-hidden focus-within:ring-1 focus-within:ring-green-500 focus-within:border-green-500">
                ...
                <input type="tel" name="phone" id="field_phone" value="{{ old('phone') }}"
        ...
        <div>
            ...
            <div class="flex rounded border border-gray-300 overflow-hidden focus-within:ring-1 focus-within:ring-green-500 focus-within:border-green-500">
                ...
                <input type="tel" name="whatsapp" id="field_whatsapp" value="{{ old('whatsapp') }}"
                       class="flex-1 px-3 py-1.5 border-0 focus:ring-0 text-sm" placeholder="+1 234 567 890">
            </div>
        </div>
        ...
        <div>
            ...
            <div class="flex rounded border border-gray-300 overflow-hidden focus-within:ring-1 focus-within:ring-green-500 focus-within:border-green-500">
                ...
                <input type="text" name="telegram" id="field_telegram" value="{{ old('telegram') }}"
        ...
        <div>
            ...
            <div class="flex rounded border border-gray-300 overflow-hidden focus-within:ring-1 focus-within:ring-green-500 focus-within:border-green-500">
                ...
                <input type="url" name="linkedin" id="field_linkedin" value="{{ old('linkedin') }}"
        ...
        <div>
            ...
            <div class="flex rounded border border-gray-300 overflow-hidden focus-within:ring-1 focus-within:ring-green-500 focus-within:border-green-500">
                ...
                <input type="url" name="facebook" id="field_facebook" value="{{ old('facebook') }}"
        ...
        <div>
            ...
            <div class="flex rounded border border-gray-300 overflow-hidden focus-within:ring-1 focus-within:ring-green-500 focus-within:border-green-500">
                ...
                <input type="text" name="discord" id="field_discord" value="{{ old('discord') }}"
    ...
    <div class="grid grid-cols-2 gap-4">
        ...
        <div>
            ...
            <select name="location_country_id"
                ...
                <option value="">— None —</option>
                @foreach($countries as $c)
                    <option value="{{ $c->id }}" {{ old('location_country_id') == $c->id ? 'selected' : '' }}>
                        {{ $c->country_name }}
                    </option>
                @endforeach
            </select>
        ...
        <div>
            ...
            <input type="number" step="any" name="location_lat" value="{{ old('location_lat') }}"
                   class="w-full border border-gray-300 rounded px-2 py-1 focus:ring-green-500 focus:border-green-500"
                   placeholder="e.g. 41.9028">
        </div>
        <div>
            <label class="block text-gray-700 font-medium mb-1">Longitude</label>
            <input type="number" step="any" name="location_lng" value="{{ old('location_lng') }}"
                   class="w-full border border-gray-300 rounded px-2 py-1 focus:ring-green-500 focus:border-green-500"
...
$(function () {
    ...
    function renderChannelPreview(n) {
        ...
        preview.innerHTML = `
            <div class="inline-flex items-center gap-2 px-3 py-1.5 bg-white border border-gray-200 rounded-lg text-sm shadow-sm">
                ...
                <span class="text-gray-${val ? '700' : '300'}">${val || 'not set yet'}</span>
            </div>`;
    }
    ...
    /* Update previews when contact fields change */
