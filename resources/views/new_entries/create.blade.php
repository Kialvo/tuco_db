                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <option value="read_but_never_answered"
                                {{ old('status', $entry->status ?? '') === 'read_but_never_answered' ? 'selected' : '' }}>
                            ...
                            <option value="refused_by_us"
                                {{ old('status', $entry->status ?? '') === 'refused_by_us' ? 'selected' : '' }}>
                                Refused by us
                            </option>

                            <option value="publisher_refused"
                                {{ old('status', $entry->status ?? '') === 'publisher_refused' ? 'selected' : '' }}>
                                Publisher refused
                            </option>

                            <option value="negotiation"
                                {{ old('status', $entry->status ?? '') === 'negotiation' ? 'selected' : '' }}>
                                Negotiation
                            </option>

                            <option value="active"
                                {{ old('status', $entry->status ?? '') === 'active' ? 'selected' : '' }}>
                                Active
                            </option>

                            <option value="past"
                                {{ old('status', $entry->status ?? '') === 'past' ? 'selected' : '' }}>
                                Past
                            </option>
                        </select>
