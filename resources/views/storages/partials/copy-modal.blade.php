{{-- Copywriter Details modal (storages) --}}
<div id="copyModal"
     class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50 p-4 flex"
     aria-labelledby="modalCopyTitle"
     role="dialog"
     aria-modal="true">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md flex flex-col max-h-[90vh]">
        {{-- Header --}}
        <div class="flex items-center justify-between px-5 py-3 border-b border-gray-100 flex-shrink-0">
            <h2 id="modalCopyTitle" class="text-base font-bold text-gray-800">Copywriter Details</h2>
            <button type="button" id="closeCopyModal"
        ...
        <div class="px-5 py-4 overflow-y-auto slim-scroll flex-1">
            <dl class="divide-y divide-gray-100 text-sm">
                <div class="py-2 grid grid-cols-3 gap-2">
                    <dt class="text-xs font-semibold text-gray-500 uppercase tracking-wider">Copywriter</dt>
                    <dd id="modalCopyVal" class="col-span-2 text-gray-800 break-words"></dd>
                </div>
            </dl>
        </div>
        ...
        <div class="px-5 py-3 border-t border-gray-100 flex justify-end rounded-b-2xl flex-shrink-0">
            <button type="button" id="closeCopyModalBottom"
