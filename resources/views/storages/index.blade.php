            ...
            <div class="flex flex-wrap gap-2 mb-2">
                ...
                <div class="flex flex-col">
                    ...
                    <select id="filterLanguage"
                            class="border border-gray-300 rounded px-2 py-2 w-28 focus:ring-cyan-500 focus:border-cyan-500">
    ...
    <script>
        ...
        $(function () {
            ...
            $('#filterLanguage, #filterCountry, #filterClient, #filterCopy, #filterCategories')
                .select2({
                    width:'resolve', dropdownAutoWidth:true, placeholder:'Select', allowClear:true,
