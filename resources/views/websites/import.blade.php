...
@section('content')
    ...
    <div class="bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between flex-shrink-0">
        <div>
            <h1 class="text-base font-bold text-gray-800">Bulk Import Domains</h1>
            <p class="text-xs text-gray-500 mt-0.5">Upload a metrics CSV to update many domains at once.</p>
        </div>
    </div>
