...
@section('content')
    ...
    <div class="bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between flex-shrink-0">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-0.5">Parent organizations linked to your clients.</p>
        </div>
    ...
    <div id="createModal"
        ...
        <div class="bg-white border border-gray-200 p-6 rounded-2xl shadow-2xl max-w-md w-full mx-2 relative">
            ...
            <form id="createCompanyForm" class="space-y-5">
                ...
                <div class="pt-2">
                    <button type="submit"
                            class="bg-green-700 text-white px-5 py-2 rounded shadow-sm hover:bg-green-800
